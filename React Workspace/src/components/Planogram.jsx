...
const Planogram = ({ products, locations, planogram, onProductClick }) => {
  ...
  const handlePopup = (product, event) => {
                  ...
                  locationProducts.map((product, i) =>
                    Array.from({ length: product.quantity }).map((_, j) => (
                      <div
                        ...
                        // onClick={() => handleDelete(product, rowIndex, colIndex, product.index, planogram.planogramId)}
                        onClick={(e) => handlePopup(product, e)}
                      />
                    ))
                  )
                ) : (
